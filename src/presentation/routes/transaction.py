...
from src.application.use_cases.transaction.verify_transaction import VerifyTransactionUseCase
...
from src.infrastructure.repositories.itransaction_repository import ITransactionRepository
...
@transaction_router.get("/transactions/{transaction_id}/verify",
