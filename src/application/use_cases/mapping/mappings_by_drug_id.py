...
from src.infrastructure.repositories.contract import (
    DrugCatalogRepositoryInterface, DrugRepositoryInterface, MappingRepositoryInterface)
...
class DrugMappingsUseCase:
    ...
    async def execute(self, drug_id: int) -> CentralDrugMappingDto:
        ...
        mappings = await self.mapping_repository.\
            get_mappings_by_central_drug_id(drug_id)
